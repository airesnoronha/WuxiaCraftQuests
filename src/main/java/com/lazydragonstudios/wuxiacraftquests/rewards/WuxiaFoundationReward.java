...
public class WuxiaFoundationReward extends Reward {

	public System system = System.ESSENCE;

	public BigDecimal amount = BigDecimal.ZERO;

	public WuxiaFoundationReward(Quest q) {
		super(q);
	}

	@Override
	public RewardType getType() {
		return WuxiaRewardTypes.FOUNDATION_REWARD_TYPE;
	}
	...
	public void claim(ServerPlayer serverPlayer, boolean b) {
		...
		systemData.setStat(PlayerSystemStat.FOUNDATION, systemData.getStat(PlayerSystemStat.FOUNDATION).add(this.amount).max(BigDecimal.ZERO));
	}
